Dear NeseOS fans. We're working to migrate ElvinX to RavanaX (due to recent name changes). 
...
Starting June 3, 2026, we introducing a Nese Server 2012 R2 operating system and the RavanaX already pre installed. However, the RavanaX trademark is owned by [RavanaX](https://elvinx.qzz.io) itself (NeseOS embeds ElvinX or RavanaX app to ensure that users can use safety).
